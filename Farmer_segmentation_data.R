...
#spread fertiliser data
# Fertilizer_use_subsidytype_bought1<- tidyr::pivot_wider(Fertilizer_use_subsidytype_bought, names_from = `eia_addon_part_1/eia_addon_ag_inputs_title/eia_addon_Agri_Inputs/fertilizers_grp/Fertilizer_use_subsidytype_bought_eia_addon_part_1/eia_addon_ag_inputs_title/eia_addon_Agri_Inputs/fertilizers_grp/Fertilizer_use_subsidytype_bought/specific_Fertilizer_use_subsidytype`, 
#                                                         values_from = c("eia_addon_part_1/eia_addon_ag_inputs_title/eia_addon_Agri_Inputs/fertilizers_grp/Fertilizer_use_subsidytype_bought_eia_addon_part_1/eia_addon_ag_inputs_title/eia_addon_Agri_Inputs/fertilizers_grp/Fertilizer_use_subsidytype_bought/Fertilizer_use_subsidytype_qty","eia_addon_part_1/eia_addon_ag_inputs_title/eia_addon_Agri_Inputs/fertilizers_grp/Fertilizer_use_subsidytype_bought_count","eia_addon_part_1/eia_addon_ag_inputs_title/eia_addon_Agri_Inputs/fertilizers_grp/Fertilizer_use_subsidytype_bought"))
...
# export the data to xlsx
 datasets1<- list("main_data"=original_data1,"plot_info"=plot_unnested2,
                  "HH_data"=HH_data,"hh_plots_repeat"=hh_plots_repeat,"extension_repeat"=extension_repeat,
                  "Fertilizer_use_subsidytype_bought"=Fertilizer_use_subsidytype_bought,"crop_repeat"=crop_repeat)

 writexl::write_xlsx(datasets1,
            "D:/IITA/data/farmer_seg_data.xlsx")

 
 
#merge all the data into 1
 
list1<-list(original_data1,plot_unnested2,hh_plots_repeat,hh_members_names_repeat,hh_members_details_repeat,extension_repeat,Fertilizer_use_subsidytype_bought,crop_repeat)
...
mytempdata = merge(mytempdata, mydata3)
 ...
 df_list <- list(original_data1,plot_unnested2,hh_plots_repeat,hh_members_names_repeat,hh_members_details_repeat,extension_repeat,Fertilizer_use_subsidytype_bought,crop_repeat)      
 
 Reduce(function(x, y) merge(x, y, all=TRUE), df_list)
 
 
 
 combined_data<-df_list %>% reduce(inner_join, by=c("eia_addon_survey/eia_addon_metadata_title/eia_addon_barcodeenumerator_1","eia_addon_survey/eia_addon_metadata_title/eia_addon_barcodehousehold_1")) %>% 
   rename_with(
